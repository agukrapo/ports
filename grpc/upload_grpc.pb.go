...
func (c *uploadClient) Upload(ctx context.Context, opts ...grpc.CallOption) (Upload_UploadClient, error) {
	stream, err := c.cc.NewStream(ctx, &Upload_ServiceDesc.Streams[0], "/grpc.Upload/Upload", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *uploadUploadClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *uploadUploadClient) CloseAndRecv() (*Response, error) {
...
func (x *uploadUploadServer) SendAndClose(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *uploadUploadServer) Recv() (*Request, error) {
	m := new(Request)
